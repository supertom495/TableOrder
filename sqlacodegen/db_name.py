...
class OnlineUpdate(Base):
    __tablename__ = 'OnlineUpdate'

    id = Column(Integer, primary_key=True)
    request_datetime = Column(DateTime, nullable=False)
    ref_id = Column(Integer)
    ref_type = Column(SmallInteger)
    supplier = Column(Unicode(10))
    staff_id = Column(Integer)
    status = Column(SmallInteger)
    cmd = Column(Unicode(30))
    param1 = Column(Unicode(1000))
    param2 = Column(Unicode(1000))
    param3 = Column(Unicode(1000))
    param4 = Column(Unicode(1000))
    param5 = Column(Unicode(1000))
    response_status = Column(Integer)
    response_status_msg = Column(Unicode(100))
    response_datetime = Column(DateTime)
    response_msg1 = Column(Unicode(100))
    response_msg2 = Column(Unicode(1000))
...
class DocketAddres(Base):
    ...
    phone = Column(Unicode(20), nullable=False)
    delivery_date = Column(Unicode(30))
